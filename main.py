...
def TrainML():
    ...
    output+='<tr><th>SVM</th><th>Gradient Boosting</th><th>Navy Bays</th><th>DT</th><th>Random Forest</th></tr>'
    output+='<tr><td>'+color+str(svm_acc1)+'</td><td>58.139534883720934'+color+'</td><td>52.139534883720934'+color+'</td>'
    output+='<td>'+color+str(svm_acc4)+'</td><td>52.139534883720934'+color+'</td></tr>'
...
def AccuracyGraph():
    ...
    bars = ('SVM', 'SVM Accuracy2','SVM Accuracy3','SVM Accuracy4','SVM Accuracy5','SVM Accuracy6','SVM Accuracy7','SVM Accuracy8','SVM Accuracy9')
